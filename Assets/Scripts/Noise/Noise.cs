...
public static class Noise {
    ...
    public static float[,,] GenerateNoiseMap(int width, int height, int depth, int mapSeed, float noiseScale, int numNoiseOctaves, float persistence, float lacunarity, Vector3 manualOffset) {
